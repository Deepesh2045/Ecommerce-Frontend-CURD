...
console.log(data)
  ...
  const {isLoading:updateCartQuantityLoading, mutate: updateQuantityMutate } = useMutation({
  ...
  if (isLoading || updateCartQuantityLoading) {
    return <Loading />;
  }
            ...
            return (
              ...
              >
                ...
                <Stack flexDirection="row" alignItems="center" gap="8px">
                  <Box>
                    <IconButton 
                    disabled={updateCartQuantityLoading || item?.orderedQuantity===1} onClick={() => {
                        updateQuantityMutate({productId:item?.productId,action:"dec"})
                      }}>
                      <RemoveIcon />
                    </IconButton>
                  </Box>
                  ...
                  <Box>
                    ...
                    disabled={updateCartQuantityLoading}
                      onClick={() => {
                        updateQuantityMutate({productId:item?.productId,action:"inc"})
